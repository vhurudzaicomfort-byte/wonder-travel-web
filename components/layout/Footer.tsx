        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-5 flex gap-3">
            ...
            {business.social.instagram && (
              <a href={business.social.instagram} aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="rounded-lg border border-white/15 p-2 hover:bg-white/10">
                <InstagramIcon />
              </a>
            )}
          </div>
